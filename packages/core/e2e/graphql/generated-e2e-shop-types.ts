...
export namespace TestOrderFragment {
  ...
  export type _Adjustments = (NonNullable<(NonNullable<TestOrderFragmentFragment['lines'][0]>)['adjustments'][0]>);
...
export namespace AddItemToOrder {
  ...
  export type Adjustments = (NonNullable<(NonNullable<(NonNullable<AddItemToOrderMutation['addItemToOrder']>)['lines'][0]>)['adjustments'][0]>);
  export type _Adjustments = (NonNullable<(NonNullable<AddItemToOrderMutation['addItemToOrder']>)['adjustments'][0]>);
}
...
export namespace SearchProductsShop {
  ...
  export type SinglePriceInlineFragment = (DiscriminateUnion<RequireField<(NonNullable<SearchProductsShopQuery['search']['items'][0]>)['price'], '__typename'>, { __typename: 'SinglePrice' }>);
  export type PriceRangeInlineFragment = (DiscriminateUnion<RequireField<(NonNullable<SearchProductsShopQuery['search']['items'][0]>)['price'], '__typename'>, { __typename: 'PriceRange' }>);
}
