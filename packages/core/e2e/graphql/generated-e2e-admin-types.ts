...
export namespace GetProductCollectionsWithParent {
  ...
  export type Collections = (NonNullable<(NonNullable<GetProductCollectionsWithParentQuery['product']>)['collections'][0]>);
  export type Parent = (NonNullable<(NonNullable<(NonNullable<GetProductCollectionsWithParentQuery['product']>)['collections'][0]>)['parent']>);
}
...
export namespace GetCustomerGroup {
  ...
  export type Items = (NonNullable<(NonNullable<GetCustomerGroupQuery['customerGroup']>)['customers']['items'][0]>);
}
